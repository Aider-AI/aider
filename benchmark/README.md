...
- `--retry-wait` uses a fixed number of seconds between API retries, overriding the default exponential backoff. Helpful when providers rate-limit aggressively (e.g., `--retry-wait 1.0`).
